...
use App\Repositories\Eloquent\EloquentSensorPintuLogRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(SensorPintuLogRepository::class, function () {

            $repository = new EloquentSensorPintuLogRepository(new SensorPintuLog());
